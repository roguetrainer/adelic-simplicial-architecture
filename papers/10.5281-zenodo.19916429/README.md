...
Specifies the Origami ISA: a machine-code level instruction set for the topological processor using Pachner moves as opcodes and simplicial paging for memory management.
